...
analysis_data = read_csv('data/cleaned_data/cleaned_data.csv')
analysis_data_inverted = read_csv('data/cleaned_data/cleaned_data_inverted.csv')

analysis_data
analysis_data_inverted

...
There is a huge price disparity between the expenses of the 11 families. The biggest expense was rent, at an average of $3146 per month, followed by food costs at $705. The huge cost rent highlights a need for further investigation and is discussed in @sec-discussion. See `Table 3` for an overview of the dataset.
...
#| fig-cap: "Figure 2: Expense Breakdown of Low Income Households in Toronto"
#| echo: false
